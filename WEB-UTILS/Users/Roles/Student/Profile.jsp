...
%>
        ...
        <div class="top-0 left-0 right-0 bg-white shadow-md flex items-center justify-center p-4 z-10">
            <ul class="flex space-x-4">
                <li><a href="../../../../../JavaProject/AlumniList">Alumni</a></li>
                <li><a href="../../../../../JavaProject/WEB-UTILS/Users/Roles/Student/Project.jsp">Project</a></li>
                <li><a href="../../../../../JavaProject/WEB-UTILS/Users/Roles/Student/Student.jsp">Profile</a></li>
