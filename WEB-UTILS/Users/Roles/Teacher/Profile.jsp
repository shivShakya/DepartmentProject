...
%>
        ...
        <div class="top-0 left-0 right-0 bg-white shadow-md flex items-center justify-center p-4 z-10">
            <ul class="flex space-x-4">
                <li><a href="../../../../../JavaProject/UserList">Users</a></li>
                <li><a href="../../../../../JavaProject/WEB-UTILS/Users/Roles/Teacher/Teacher.jsp">Profile</a></li>
                <li><a href="../../../../../JavaProject/Logout">LogOut</a></li>
            </ul>
            <div class="w-96"></div>
            <div class="flex items-center justify-center">
                <img src="<%= image %>" alt="profile-img" class="w-24 h-24 rounded-full"/>
